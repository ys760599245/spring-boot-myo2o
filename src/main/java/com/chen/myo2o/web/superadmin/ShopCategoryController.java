...
import com.chen.myo2o.dto.ShopCategoryExecution;
import com.chen.myo2o.entity.ConstantForSuperAdmin;
...
public class ShopCategoryController {
    ...
    private Result<List<ShopCategory>> list1stLevelShopCategorys() {
        ...
        try {
            ...
            return new Result<List<ShopCategory>>(false, a.getState(), a.getStateInfo());
        }
