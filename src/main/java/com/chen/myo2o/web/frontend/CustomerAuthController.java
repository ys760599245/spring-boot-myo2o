...
public class CustomerAuthController {
  ...
  /*  @RequestMapping(value = "listmainpageinfo", method = RequestMethod.GET)
    @ResponseBody
    public Map<String, Object> listmainpageinfo() throws IOException {
        Map<String, Object> modelMap = new HashMap<>();
        HeadLine headLineContion = new HeadLine();
        headLineContion.setEnableStatus(1);
        List<HeadLine> headLineList = headLineService.getHeadLineList(headLineContion);
        modelMap.put("success", true);
